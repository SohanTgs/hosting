                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control form--control" name="gateway" required>
                                ...
                                <option value="{{$data->method_code}}" {{ old('gateway') == $data->method_code ? 'selected' : '' }} data-gateway="{{ $data }}">{{$data->name}}</option>
                                @endforeach 
                            </select>
                        </div>
                        ...
                        <div class="form-group d-none">
                            ...
                            <div class="input-group">
                                <input type="text" name="amount" class="form-control form--control" value="{{ $totalPayment }}" required>
                        ...
                        <div class="mt-3">
                            <ul class="list-group text-center">
                                ...
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span><span class="fw-bold">{{ showAmount($totalPayment) }}</span> {{__($general->cur_text)}}</span>
                                </li>
                        ...
                        <button type="submit" class="btn text-white bg-primary w-100 mt-3">@lang('Submit')</button>
                    </div>
                </div>
            </form>
        </div>
