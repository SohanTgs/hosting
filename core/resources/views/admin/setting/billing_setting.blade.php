                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label class="d-block">
                                    <span class="text--success">@lang('Enter the default number of days before the due payment date to generate invoices')</span>
                                    <a href="javascript:void(0)" class="text--primary advanceBtn">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label class="text--success d-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label class="d-block text-success">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label class="text--success d-block">@lang('Check to activate invoice payment reminder emails')</label>
                            </div>
                            <input type="checkbox" data-width="100%" data-size="sm" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data- data-off="@lang('Disabled')" data-on="@lang('Enabled')" name="invoice_send_reminder" @if(@$setting->invoice_send_reminder) checked @endif>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('Advanced Settings')</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('admin.billing.setting.update.invoice') }}" method="POST">
                @csrf
                <div class="modal-body">
                        ...
                        <div class="col-lg-12 mt-4">
                            <div class="custom-pricing">
                                <div class="border-line-area">
                                    <h6 class="border-line-title text-center font-weight-bold">@lang('Per Billing Cycle Settings')</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-4">
                            <div class="custom-pricing">
                                <div class="border-line-area">
                                    <h6 class="border-line-title text-center font-weight-bold">@lang('Domain Settings')</h6>
                                    <span class="text-center d-block mb-3">
