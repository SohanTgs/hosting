    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive(['admin.service.category.all'])}}">
                    <a href="{{route('admin.service.category.all')}}" class="nav-link ">
                        <i class="menu-icon las la-clipboard-list"></i>
                        <span class="menu-title">@lang('Service Categories')</span>
                    </a>
                </li>
 
                <li class="sidebar-menu-item {{menuActive('admin.configurable*')}}">
                    <a href="{{route('admin.configurable.group.all')}}" class="nav-link ">
                        <i class="menu-icon las la-cog"></i>
                        <span class="menu-title">@lang('Configuration')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.group.server*')}}">
                    <a href="{{route('admin.group.server.all')}}" class="nav-link ">
                        <i class="menu-icon las la-server"></i>
                        <span class="menu-title">@lang('Server Groups')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.server*')}}">
                    <a href="{{route('admin.server.all')}}" class="nav-link "> 
                        <i class="menu-icon las la-server"></i>
                        <span class="menu-title">@lang('Servers')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.domain*')}}">
                    <a href="{{route('admin.domain.all')}}" class="nav-link "> 
                        <i class="menu-icon las la-globe"></i>
                        <span class="menu-title">@lang('Domains')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.order*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.order.active')}}">
                                <a href="{{route('admin.order.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.order.pending')}}">
                                <a href="{{route('admin.order.pending')}}" class="nav-link">
                                    ...
                                    @if($pendingOrders)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pendingOrders}}</span>
                                    @endif
                                </a> 
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.invoice*',3)}}">
                        <i class="menu-icon las la-file-invoice"></i>
                        <span class="menu-title">@lang('Manage Invoice')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.invoice*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.invoice.all')}}">
                                <a href="{{route('admin.invoice.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.invoice.paid')}}">
                                <a href="{{route('admin.invoice.paid')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Paid')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.invoice.unpaid')}}">
                ...
                <li class="sidebar-menu-item {{menuActive(['admin.hosting.plan.all', 'admin.hosting.plan.new'])}}">
                    <a href="{{route('admin.hosting.plan.all')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Hosting Plans ---')</span>
                    </a>
                </li>
