                ...
                <form action="{{ route('user.domain.contact.update') }}" method="post">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs mb-4" id="tab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" id="register-tab" data-toggle="tab" href="#register" role="tab" aria-controls="register" aria-selected="true">
                                  @lang('Register')
                              </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="aux-tab" data-toggle="tab" href="#aux" role="tab" aria-controls="aux" aria-selected="false">
                                  @lang('AuxBilling')
                              </a>
                            </li>
                          </ul>
                          ...
                          <button type="submit" class="btn btn-success mt-4 btn-block">@lang('Submit')</button>
                    </div>
                </form>
            </div> 
        </div>
