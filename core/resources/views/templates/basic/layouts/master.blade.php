                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            @lang('Service') <span class="caret"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{route('user.my.services')}}">@lang('My Services')</a>
                            <a class="dropdown-item" href="{{route('home')}}">@lang('Order New Service')</a>
                        </div>
                    </li>
